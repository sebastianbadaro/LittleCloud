...
class DashboardController extends Controller
{
  ...
  public function Stock()
  {
    ...
    $amountofItemsInStock = Product::amountofItemsInStock();
    $totalAmountOfClients = Client::totalAmountOfClients();
    return view('dashboards.dashboardStock',compact('totalValueOfStock','amountofItemsInStock','totalAmountOfClients','subcategorias','brands','genders','paymentTypes','lastMonthSales','currentmonthSalesAmountByDay','thisMonthTotalSales','thisMonthAmountOfSales','thisMonthSoldItems'));
  }
}
